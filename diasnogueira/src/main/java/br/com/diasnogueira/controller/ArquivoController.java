...
import br.com.diasnogueira.service.arquivo.IArquivoService;
...
public class ArquivoController {
    ...
    public ResponseEntity<Object> uploadEnvioDocumento(@RequestParam(name = "arquivo") MultipartFile arquivo){
        Arquivo arq = arquivoService.saveEnvioDocumento(arquivo);
        if(arq!=null){
            return ResponseEntity.status(HttpStatus.CREATED).body(arq);
        }
